                        ...
                        <div class="container">
                            <div class="row" id="button-maison">
                                <div classe="col-12">
                                    <div class="checkbox" >
                                        <label >
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100" data-height="30"  data-off="Maison" data-on="<i class='fas fa-home'></i> Maison" data-onstyle="primary" data-offstyle="success">
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                                ...
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label style="height:100%;">
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100" data-size="mini" data-height="150" data-on="Appartement" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100" data-on="Kot" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100" data-on="Loft" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100" data-on="Penthouse" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                    </div>
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100" data-on="Groundfloor" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100" data-on="Studio" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100" data-on="Extra" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100" data-on="Uniplex" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100"  data-on="Unicorn" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100"  data-on="Unicode" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                    </div>
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100"  data-on="Rectouch" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100"  data-on="Hapenis" data-height="150" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-1 m-3">
                                    <div class="checkbox">
                                        <label style="height:100%;">
                                            <input type="checkbox" checked data-toggle="toggle" data-width="100" data-size="mini" data-height="150" data-on="Service" data-off="Check"  data-onstyle="dark" data-offstyle="warning">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-1 m-3">
